...
class Catalog:
    ...
    # ---------- typed views ----------
    def students(self) -> List[Row]:            return self.table("students")
    def semesters(self) -> List[Row]:           return self.table("semesters")
    def prerequisites(self) -> List[Row]:       return self.table("prerequisites")
    def major_course(self) -> List[Row]:        return self.table("major_course")
    def majors(self) -> List[Row]:              return self.table("majors")
    def courses(self) -> List[Row]:             return self.table("courses")
    def courses_offered(self) -> List[Row]:     return self.table("courses_offered")
    def degree_requirements(self) -> List[Row]: return self.table("degree_requirements")
    def constraints(self) -> List[Row]:         return self.table("constraints")
    def departments(self) -> List[Row]:         return self.table("departments")

    # ---------- lookups ----------
    def student(self, student_id) -> Optional[Row]:
        return self._students_by_id.get(str(student_id))

    def major_id_for_student(self, student_id) -> Optional[str]:
        s = self.student(student_id)
        return s.get("MajorID") if s else None
    ...
    def _build_indexes(self) -> None:
        self._students_by_id = {r.get("StudentID"): r for r in self.students()}
